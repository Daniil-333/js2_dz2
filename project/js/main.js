...
class Cart {
    ...
    // getQuote() - Я не совсем понял, о чём здесь речь? На вид это обычная форма для заполнения адреса доставки. Если натолкнёте меня на мысль, буду очень признателен)
